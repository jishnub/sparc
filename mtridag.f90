...
!
!     This solves a set of tridiagonal systems in parallel
!     Adapted from Press etal. 
!     Revised 3/17/98 for periodic boundaries -- NEH
!     fixed to cope with zero pivots like tridag 6/16/99 -- NEH
!**************************************************************************
      PARAMETER (NMAX=700)
...
!
         ...
         enddo
!
! and now do the forward & backward substitution
!
         DO I=1,N1
            ud(1)=r(I,1)
            do j=2,n2-1
...
!     Coping with Zero pivots on boundary
!
! do the forward & backward substitution
!
         DO I=1,N1
            ud(1)=r(i,1)/b(1)
            betas(1)=1
